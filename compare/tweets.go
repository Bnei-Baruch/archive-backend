...
// TweetsComparator compares tweets between ES6 and ES9
type TweetsComparator struct {
	es6Client    *elastic.Client
	es9Client    *elasticsearch.Client
	es9IndexBase string
}

// NewTweetsComparator creates a new tweets comparator
func NewTweetsComparator(es6Client *elastic.Client, es9Client *elasticsearch.Client, es9IndexBase string) *TweetsComparator {
	return &TweetsComparator{
		es6Client:    es6Client,
		es9Client:    es9Client,
...
func (c *TweetsComparator) GetES9Count(ctx context.Context, lang string) (int64, error) {
...
func (c *TweetsComparator) Sample(ctx context.Context, lang string, size int) ([]string, error) {
	indexName := c.GetES6IndexName(lang)
...
func (c *TweetsComparator) FetchES6Document(ctx context.Context, lang string, uid string) (map[string]interface{}, error) {
	indexName := c.GetES6IndexName(lang)
...
func (c *TweetsComparator) FetchES9Document(ctx context.Context, lang string, uid string) (map[string]interface{}, error) {
	indexName := c.GetES9IndexName(lang)
...
func (c *TweetsComparator) Compare(es6Doc, es9Doc map[string]interface{}) *ComparisonResult {
...
func (c *TweetsComparator) GetCriticalFields() []string {
	return []string{
		"mdb_uid",      // Tweet ID
		"result_type",
		"title",        // Tweet text
		"effective_date", // Tweet posted date
	}
}

// GetIgnoredFields returns fields that are expected to differ
func (c *TweetsComparator) GetIgnoredFields() []string {
	return []string{
		"index_date",
		"_id",
		"_index",
