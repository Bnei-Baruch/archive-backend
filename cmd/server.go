...
func serverFn(cmd *cobra.Command, args []string) {
	...
	router.Use(
		...
		utils.DataStoresMiddleware(common.DB, common.ESC, common.LOGGER, common.SEARCH_CACHE, common.CACHE /*common.GRAMMARS,*/, common.TOKENS_CACHE, common.CMS, common.VARIABLES),
