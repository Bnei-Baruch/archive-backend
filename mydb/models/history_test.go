...
var (
	historyDBTypes = map[string]string{`AccountID`: `character varying`, `ContentUnitType`: `bigint`, `CreatedAt`: `timestamp with time zone`, `EventType`: `bigint`, `ID`: `bigint`, `UID`: `character varying`}
	_              = bytes.MinRead
)
