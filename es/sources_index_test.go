...
func (suite *SourcesIndexerSuite) TestSourcesIndex() {
	...
	suite.serverResponses["/uid2text/8awHBfjU"] = fContentHe
	suite.serverResponses["/uid2text/frnHYhIw"] = fContentEn
	...
	suite.serverResponses["/uid2text/QrtIVYJA"] = fContentEn2
	suite.serverResponses["/uid2text/bBBIDCiy"] = "TEST CONTENT HE 2"
	...
	suite.serverResponses["/uid2text/72QvKVD8"] = "TEST CONTENT HE Shamati"
	suite.serverResponses["/uid2text/yww1AnQ9"] = "TEST CONTENT HE Shamati"
	...
	suite.serverResponses["/uid2text/pO6QWIAZ"] = "TEST CONTENT HE Chapter"
	suite.serverResponses["/uid2text/Q7XSgAZy"] = "TEST CONTENT EN Chapter"
