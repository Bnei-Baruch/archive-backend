...
func DataStoresMiddleware(mbdDB *sql.DB, esManager, logger, searchCache, cm interface{} /*grammars interface{},*/, tc interface{}, cms interface{}, variables interface{}) gin.HandlerFunc {
	return func(c *gin.Context) {
		c.Set("MDB_DB", mbdDB)
		c.Set("ES_MANAGER", esManager)
		c.Set("LOGGER", logger)
		c.Set("SEARCH_CACHE", searchCache)
		c.Set("CACHE", cm)
