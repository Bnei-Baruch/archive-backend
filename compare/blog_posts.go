...
// BlogPostsComparator compares blog posts between ES6 and ES9
type BlogPostsComparator struct {
	es6Client    *elastic.Client
	es9Client    *elasticsearch.Client
	es9IndexBase string
}

// NewBlogPostsComparator creates a new blog posts comparator
func NewBlogPostsComparator(es6Client *elastic.Client, es9Client *elasticsearch.Client, es9IndexBase string) *BlogPostsComparator {
	return &BlogPostsComparator{
		es6Client:    es6Client,
		es9Client:    es9Client,
...
func (c *BlogPostsComparator) GetResultType() string {
	return consts.ES_RESULT_TYPE_BLOG_POSTS
}

// GetES6IndexName returns ES6 index name for a language
func (c *BlogPostsComparator) GetES6IndexName(lang string) string {
	return fmt.Sprintf("prod_%s_%s", consts.ES_RESULTS_INDEX, lang)
}

// GetES9IndexName returns ES9 index name for a language
func (c *BlogPostsComparator) GetES9IndexName(lang string) string {
	return fmt.Sprintf("%s_%s", c.es9IndexBase, lang)
}

// GetES6Count returns total document count in ES6 for this result type
func (c *BlogPostsComparator) GetES6Count(ctx context.Context, lang string) (int64, error) {
...
func (c *BlogPostsComparator) GetES9Count(ctx context.Context, lang string) (int64, error) {
...
func (c *BlogPostsComparator) Sample(ctx context.Context, lang string, size int) ([]string, error) {
	indexName := c.GetES6IndexName(lang)
...
func (c *BlogPostsComparator) FetchES6Document(ctx context.Context, lang string, uid string) (map[string]interface{}, error) {
	indexName := c.GetES6IndexName(lang)
...
func (c *BlogPostsComparator) FetchES9Document(ctx context.Context, lang string, uid string) (map[string]interface{}, error) {
	indexName := c.GetES9IndexName(lang)
...
func (c *BlogPostsComparator) Compare(es6Doc, es9Doc map[string]interface{}) *ComparisonResult {
...
func (c *BlogPostsComparator) GetCriticalFields() []string {
	return []string{
		"mdb_uid",      // Format: "blog_id-wp_id"
		"result_type",
		"title",
		"content",      // HTML-converted text
		"effective_date", // Posted date
	}
}

// GetIgnoredFields returns fields that are expected to differ
func (c *BlogPostsComparator) GetIgnoredFields() []string {
	return []string{
		"index_date",
		"_id",
		"_index",
