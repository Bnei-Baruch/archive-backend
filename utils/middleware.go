...
func DataStoresMiddleware(mbdDB *sql.DB, esManager, cm interface{} /*grammars interface{},*/, tc interface{}, cms interface{}, variables interface{}, llmTools interface{}, llmService interface{}, llmProgress interface{}, llmWorkflow interface{}) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.Set("CMS", cms)
		c.Set("LLM_TOOLS", llmTools)
		c.Set("LLM_SERVICE", llmService)
		c.Set("LLM_REASONING_PROGRESS", llmProgress)
		c.Set("LLM_REASONING_WORKFLOW", llmWorkflow)
		c.Next()
	}
}
