...
func DataStoresMiddleware(mbdDB *sql.DB, esManager, cm interface{} /*grammars interface{},*/, tc interface{}, cms interface{}, variables interface{}, llmRuntime interface{}) gin.HandlerFunc {
