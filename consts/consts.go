...
const (
	...
	GRAMMAR_INTENT_FILTER_BY_DATE                 = "by_date"
...
var GRAMMAR_INTENTS_TO_FILTER_VALUES = map[string]map[string][]string{
	...
	GRAMMAR_INTENT_FILTER_BY_DATE: map[string][]string{
		FILTERS[FILTER_UNITS_CONTENT_TYPES]: []string{CT_LESSON_PART, CT_FULL_LESSON, CT_VIDEO_PROGRAM_CHAPTER, CT_VIRTUAL_LESSON, CT_LECTURE,
			CT_WOMEN_LESSON, CT_EVENT_PART, CT_FRIENDS_GATHERING, CT_MEAL, CT_CLIP, SCT_TWEET, CT_ARTICLE, CT_PUBLICATION, CT_BLOG_POST, SCT_BLOG_POST},
		FILTERS[FILTER_COLLECTIONS_CONTENT_TYPES]: []string{CT_DAILY_LESSON, CT_VIDEO_PROGRAM, CT_VIRTUAL_LESSONS, CT_LECTURE_SERIES, CT_LECTURE_SERIES,
			CT_CONGRESS, CT_HOLIDAY, CT_UNITY_DAY, CT_FRIENDS_GATHERINGS, CT_MEALS, CT_ARTICLES},
	},
}
...
var GRAMMAR_ALL_DATE_FORMATS_WITH_YEAR = []string{
	...
	"dd MMMM yyyy r.",     // Polish
	"dn. dd MMMM yyyy r.", // Polish
...
var GRAMMAR_MONTH_NAMES_BY_LANGUAGE = map[string][][]string{
	LANG_HEBREW: [][]string{
		[]string{
			"ינואר",
			"פברואר",
