...
./archive-backend vs_golden_html --flat_reports=${REPORT_FILE_HE},${REPORT_FILE_EN},${REPORT_FILE_RU} --golden_flat_reports=${GOLDEN_REPORT_FILE_HE},${GOLDEN_REPORT_FILE_RU},${GOLDEN_REPORT_FILE_EN} --vs_golden_html=${HTML_FILE} >> ${LOG_FILE_HTML} 2>&1
if [ $? -ne ]; then
