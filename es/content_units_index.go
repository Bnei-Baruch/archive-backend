...
func defaultContentUnitSql() string {
	// Note that CT_LIKUTIM is not filtered out and will be indexed,
	// but it is not supported by the search (only optional in the elasticsearch_search agent tool).
