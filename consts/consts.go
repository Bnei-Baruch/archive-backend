...
var CT_UNITS_MEDIA = []string{CT_CLIP, CT_VIDEO_PROGRAM_CHAPTER, CT_EVENT_PART, CT_FRIENDS_GATHERING, CT_LECTURE, CT_LESSON_PART, CT_WOMEN_LESSON, CT_VIRTUAL_LESSON, CT_MEAL}

var CT_UNITS_TEXTS = []string{CT_ARTICLE, CT_BLOG_POST, CT_BOOK, CT_PUBLICATION, CT_RESEARCH_MATERIAL, CT_LIKUTIM, CT_SOURCE}
